...
def Server():
    ...
    def ConnDefault():
        ...
        conn = psycopg2.connect(dbname=database_name, user=user, host=host, password=user_pass, port=local_port)
    ...
    def CreateDatabase():
        ...
        loc_conn = psycopg2.connect(user=user, host=host, password=user_pass, port=local_port)
